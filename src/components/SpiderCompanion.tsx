...
//     // The baked-in clip includes root motion (walking off in X/Z) — keep
//     // the character in place and let only the limb/pose animation play.
//     if (hipsRef.current) {
...
//     const idleSway = Math.sin(t * 0.9) * 0.12;
